...
class Config:
    ...
    AFTER_RECVD_CODE_TEXT_EN = ("✅ Code Sent to you\n"
                                ...
                                "\n<code>Use /cancel to cancel the operation</code>")
